...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/FrontendInit}
	\caption{3D-Cube}
	\label{3dcube}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/arch/M113.png}
	\caption{m113}
	\label{3dcube}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/ServerLast1.png}
	\caption{ServerLast1}
	\label{serverlast1}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/ServerLast3.png}
	\caption{ServerLast2}
	\label{serverlast2}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{images/LatenzMessung.png}
	\caption{Latenzmessung}
	\label{latenzmessung}
\end{figure}
