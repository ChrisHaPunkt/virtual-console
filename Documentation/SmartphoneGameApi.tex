...
RequireJS ist eine Bibliothe welche dazu dient, einfach JavaScript-Dateien zu modularisieren und zu laden. Es ist für den In-Browser-Einsatz optimiert, kann allerdings auch in anderen JavaScript-Umgebungen wie Rhino und Note verwendet werden.
\end{minipage}
\end{figure}
